...
/*Below is a function and variable that generates a random color that will be utilized later in the script to change the background color */
 ...
 * The printQuote function utilizes an if statement to ensure all included properties and values will print to the html doc
...
/*The next fuction then generates a new quote from the array to be printed if the refresh button is not clicked in 10 seconds*/
